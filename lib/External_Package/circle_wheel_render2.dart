...
class RenderCircleListViewport
  ...
  void performLayout() {
    ...
    final double firstVisibleOffset =
        offset.pixels + _itemExtent / 2 - visibleSize / 2 -radius;
    final double lastVisibleOffset = firstVisibleOffset + visibleSize + 2*radius;
  ...
  void _paintTransformedChild(
    ...
    if (axis == Axis.horizontal) {
      ...
      offsetToCenter = Offset(
        untransformedPaintingCoordinates.dx+radius/2,
